...
Runalyze.Statistics = (function($, Parent){
	...
	// currentUrl stays undefined when the statistics menu has no entries
	// (e.g. no plugins enabled) - none of these may throw in that case.
	self.showsTraining = function() {
		return !!currentUrl && Parent.Training.isUrl( currentUrl );
	};
