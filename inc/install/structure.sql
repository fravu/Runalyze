...
`id` int(10) unsigned NOT NULL,
  ...
  `kcal_rest` smallint unsigned DEFAULT NULL,
  `pulse_avg` tinyint unsigned DEFAULT NULL,
  `pulse_max` tinyint unsigned DEFAULT NULL,
  `pulse_avg_active` TINYINT(3) UNSIGNED DEFAULT NULL,
  `max_hr_user` TINYINT(3) UNSIGNED DEFAULT NULL,
  `hr_zone_bounds` VARCHAR(200) DEFAULT NULL,
  ...
  `fit_training_effect_benefit` tinyint(1) unsigned DEFAULT NULL,
  ...
  `fit_lactate_threshold_hr` tinyint(3) unsigned DEFAULT NULL,
  `fit_lactate_threshold_pace_ms` decimal(4,2) unsigned DEFAULT NULL,
  ...
  `fit_load_peak` SMALLINT UNSIGNED DEFAULT NULL,
  `fit_run_time` MEDIUMINT UNSIGNED DEFAULT NULL,
  `fit_walk_time` MEDIUMINT UNSIGNED DEFAULT NULL,
  `fit_stand_time` SMALLINT UNSIGNED DEFAULT NULL,
  `fit_seconds_hr_zones` VARCHAR(100) DEFAULT NULL,
  `fit_sweat_loss` SMALLINT UNSIGNED DEFAULT NULL,
  ...
  `total_cycles` smallint(5) unsigned DEFAULT NULL,
